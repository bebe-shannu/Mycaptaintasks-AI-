...
bts_hyungline.append('minyoongi') 
print ("BTS Hyungline: ",bts_hyungline)

#using insert()

bts_rapline = ['kimnamjoon', 'junghoseok'] 
bts_rapline.insert(1,'minyoongi') 
print ("BTS Rapline: ",bts_rapline)
...
BT21.pop('Jin')
print("BTS line characters BT21: ",BT21)
